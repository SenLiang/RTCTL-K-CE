...
//			System.out.println("========= DONE Loading Specs ============");
    ...
    public void RTCTLsCheckBT() throws IOException {
        ...
        Env.loadModule("testcases/bit_tick.smv");
        System.out.println("========= Loading Modules ==========");
        SMVModule main = (SMVModule) Env.getModule("main");
        System.out.println("========= Done Loading Modules ==========");
        ...
        //to_parse = "RTCTL*SPEC E(BF 8..2500(sender KNOW (receiver.state=r0 | receiver.state=r1)))";
        //to_parse = "RTCTL*SPEC A( BG 7..12 (sender.bit=1 U receiver.state=r1)) | E(X (sender KNOW receiver.state=r1))";
        to_parse = "RTCTL*SPEC !E(BF 3..8 !(sender KNOW (receiver.state=r0 | receiver.state=r1)))";

        //可用公式
        //to_parse = "RTCTL*SPEC !E(G (sender.ack -> (sender KNOW (receiver.state=r0 | receiver.state=r1)) ))";//√√√
        //to_parse = "RTCTL*SPEC A(BG 11..15 (sender KNOW (receiver.state=r0 | receiver.state=r1) | A(X sender.ack=1) ) )";
        //to_parse = "RTCTL*SPEC A(BG 11..15 (sender KNOW (receiver.state=r0 | receiver.state=r1)))";//√√√
        //to_parse = "RTCTL*SPEC !E(X (BF 7..12(sender KNOW (receiver.state=r0 | receiver.state=r1))))";
        //to_parse = "RTCTL*SPEC A(BF 8..-1(sender KNOW (receiver.state=r0 | receiver.state=r1)))";
        //to_parse = "RTCTL*SPEC A( G (sender.ack -> (sender KNOW (receiver.state=r0 | receiver.state=r1)) ))";//√√√
        //to_parse = "RTCTL*SPEC !E(G(receiver.state=r0 | receiver.state=r1) -> (F sender.ack))";//√√√
        //to_parse = "RTCTL*SPEC !E(F(sender KNOW (receiver.state=r0 | receiver.state=r1)))";//√√
       //to_parse = "RTCTL*SPEC F(sender KNOW (receiver.state=r0 | receiver.state=r1))";//√√
